        ...
        <div class="container text-center mt-60">
          <div class="row">
            ...
            <div class="col-4 mt-110">
              <div className={styles.seer}>
                <div
                  class="card h-50 shadow-lg p-3 mb-5 bg-body-tertiary rounded-5 border border-0"
                  style={{
                    borderRadius: "30px",
                    width: "72%",
                    position: "relative",
              ...
              <div className={styles.seer}>
                <div
                  class="card h-50 mt-60 shadow-lg p-3 mb-5 bg-body-tertiary rounded-5 border border-0"
                  style={{
                    borderRadius: "30px",
                    width: "72%",
                    position: "relative",
