...
import styles from "../styles/cards4midscreen.module.css";

function Cards4midscreen() {
  return (
    <>
      <div className={styles.stylone}>
        <div class="container text-center">
          <div class="row">
            <div class="col mt-40">
              <div
                class="card h-30 shadow-lg p-3 mb-5 bg-body-tertiary rounded border border-0"
                style={{
                  background:
              ...
              <div
                class="card h-30 mt-30 shadow-lg p-3 mb-5 bg-body-tertiary rounded border border-0"
                style={{
                  background:
        ...
        <div class="container text-center">
          ...
          <div class="row">
            <div class="col mt-40">
              ...
              <div
                class="card h-30 mt-30 shadow-lg p-3 mb-30 bg-body-tertiary rounded border border-0"
                style={{
                  background:
                    "linear-gradient(180deg, #FFFCAA 10.8%, rgba(255, 254, 235, 0) 100%)",
                }}
...
export default Cards4midscreen;
