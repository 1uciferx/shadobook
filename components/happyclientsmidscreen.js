...
import styles from "../styles/happyclientsmidscreen.module.css";

function Happyclientsmidscreen() {
  return (
    <>
      {/* testimonals */}
          ...
          <div className="row">
            <div className="col-lg-5 mb-30">
              <div className={styles.head1}>
                <h3
                  className="text-heading-1 mt-20"
            ...
            <div className="col-lg-7">
              <div className="row" data-masonry='{"percentPosition": true }'>
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className={styles.head2}>
                    <div className={styles.mee1}>
                      <h4 className={styles.headee1}>Royal Blue Coast</h4>
                    </div>
                  </div>
                  <div className={styles.imgp4}>
                    <p className=" ">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                <div className={styles.head2}>
                    <h4 className={styles.headee2}>Rulexx</h4>
                  </div>
                  <div className={styles.imgp4}>
                    <p className=" ">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                <div className={styles.head2}>
                    <h4 className={styles.headee3}>BMC Line Shipping</h4>
                  </div>
                  <div className={styles.imgp4}>
                    <p className=" ">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                <div className={styles.head2}>
                    <h4 className={styles.headee4}>Mercury Freight</h4>
                  </div>
                  <div className={styles.imgp4}>
                    <p className=" ">
...
export default Happyclientsmidscreen;
