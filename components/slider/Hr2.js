                            ...
                            <div className="row">
                                <div className="col-12 swiper-slide-1">
                                    <div className="grid-category grid-category-style-2">
                                        ...
                                        <div className="grid-image-center">
                                            <Link href="#"><a><img src="assets/imgs/page/homepage4/ss1.png" /></a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 swiper-slide-1">
                                    <div className="grid-category grid-category-style-2">
                                        ...
                                        <div className="grid-image-center">
                                            <Link href="#"><a><img src="assets/imgs/page/homepage4/ss4.jpg" /></a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 swiper-slide-1">
                                    <div className="grid-category grid-category-style-2">
                                        ...
                                        <div className="grid-image-center">
                                            <Link href="#"><a><img src="assets/imgs/page/homepage4/ss3.jpg" /></a></Link>
                                        </div>
                                    </div>
                                </div>
