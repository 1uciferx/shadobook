                                                        ...
                                                        <div className="grid-image-left-category">
                                                            <Link href="#"><a>
                                                                ...
                                                                <div className="category-info">
                                                                    <h3 className="text-heading-6">HR Records</h3>
                                                                </div>
                                                            </a></Link>
                                                        </div>
                                                    ...
                                                    <div className="grid-category grid-category-style-2">
                                                        <div className="grid-image-left-category">
                                                            <Link href="#"><a>
                                                                ...
                                                                <div className="category-info">
                                                                    <h3 className="text-heading-6">Accounting Modules</h3>
                                                                </div>
                                                            </a></Link>
                                                        </div>
                                                        <div className="grid-image-bottom">
                                                    ...
                                                    <div className="grid-category grid-category-style-2">
                                                        <div className="grid-image-left-category">
                                                            <Link href="#"><a>
                                                                ...
                                                                <div className="category-info">
                                                                    <h3 className="text-heading-6 mt-15">Our Modules on</h3>
                                                                    <p className="text-body-lead-large color-gray-500 mt-10">Knowledge Base</p><span className="icon-arrow-right-thin"></span>
                                                                </div>
                                                            </a></Link>
                                                        </div>
                                                        <div className="grid-image-bottom">
