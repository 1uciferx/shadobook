                        ...
                        {data.map((item, i) => (
                            <SwiperSlide>
                                <div className="swiper-slide active">
                                    <Card hoverable
                                        style={{ width: 240, }} cover= {<img src={`assets/imgs/page/homepage1/${item.avatar}`} alt="Agon" />} >
                                        <p><b>{item.name}</b></p>
                                        <p>{item.quote}</p>
                                    </Card>
...
export default Hrrecordsslider;
