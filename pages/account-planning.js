                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-7">
                                    ...
                                    <p className="text-body-lead-large color-gray-500 mt-40 pr-40">Leverage the account planning section of the CRM to drive your business towards informed decision-making when it comes to cost management and planning revenues. This section has an abundance of options along with pre-build questionnaires that will help you understand your customers better<br></br><br></br>
                                ...
                                <div className="col-lg-5 d-none d-lg-block">
                                    <div className="banner-imgs">
                                        {/* <div className="block-1 shape-1"></div><img className="img-responsive shape-1" alt="Agon" src="assets/imgs/page/about/1/banner shadobook.jpg" /> */}
                                         ...
                                         <img  className="img-responsive shape-1" src="/assets/imgs/page/about/1/banner2.png" alt="Agon" /> 
                                    </div>
                                </div>
                            </div>
                        </div>
