            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-10">
                  ...
                  <p  style={{color:"white",textAlign:"start"}} className="text-body-lead-large color-gray-500 mt-40 pr-40">
...
{/*                    
         ...
         <a tabindex="0" class="btn btn-lg btn-danger" role="button" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-title="Dismissible popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">Dismissible popover</a>
                        {/* <img  className="img-responsive mt-0" src="/accountingpage/pic1.png" alt="Agon" /> */}
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container">
            <div className="tab-content">
              <div className={activeIndex === 1 ? "tab-pane fade  active show" : "tab-pane fade "}>
                ...
                <br></br>
                <p>➟	It includes features such as connecting to bank accounts, automatically importing bank transactions, reconciling bank statements.
                  </p>
                  <br></br>
                  <p>
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-md-12">
                      <div className="box-optimized">
                        ...
                        <p>
                        ➟ The Transactions sub-module in ShadobooksERP Accounting feature includes, creating and managing invoices, vouchers, estimates, purchase orders, payslips and credit notes. </p>
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-md-12">
                      <div className="box-optimized">
                        ...
                        <p >
                        <p>
                        ➟  	The module enables users to set financial goals for various departments or divisions within their company, and then track their actual financial performance against those goals. </p>
                 <br></br>
                <p>
