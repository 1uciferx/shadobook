                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-11 box-banner-left">
                                    ...
                                    <h1 className="text-display-3 mt-30">
                                        In-depth CRM analytics to<br></br> help you make smarter business decisions
                                    </h1>
                                    <p className="text-body-lead-large color-gray-500 mt-40 pr-40">From lead analytics to deal insights, activity stats, and email analytics, ShadoBooks CRM's advanced analytics help you monitor every aspect of your sales cycle. Create customized dashboards with analytical widgets for sales, such as charts, target meters, KPIs, and funnels. Make data-driven decisions with customizable reports, and boost your sales success with actionable data intelligence.</p>
                                    <div className="mt-40">
                                        <Link href="/page-about-1"><a className="btn btn-black shape-square icon-arrow-right-white">SIGN UP NOW</a></Link>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-10 col-sm-10 col-12 text-center">
                                ...
                                <h2 className="text-display-3 color-gray-900 mb-60">Get visual answers <br className="d-lg-block d-none" />From your data</h2>
                            </div>
                            <div className="col-lg-1 col-sm-1 col-12" />
                        </div>
                    </div>
                                ...
                                <ul className="list-steps">
                                    <li className="icon-asset1 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                        <div className="text-center ">
                                            ...
                                            <h3 className="text-heading-5 mb-10">Actionable insights for everyone</h3>
                                            <p className="text-body-text color-gray-500">ShadoBook CRM Analytics empowers everyone in your organization to make data-driven decisions. This includes your C-level employees, management, and sales representatives.</p>
                                        </div>
                                    </li>
                                    {/* block-step */}
                                    <li className="icon-asset2 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                        <div className="text-center ">
                                            ...
                                            <h3 className="text-heading-5 mb-10">Multi-dimensional reports</h3>
                                            <p className="text-body-text color-gray-500">Blend your CRM data in multiple ways to understand the underlying trends. Bring together CRM data from leads, contacts, campaigns, tasks, vendors, quotes, and much more.</p>
                                        </div>
                                    </li>
                                    <li className="icon-asset3 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                        <div className="text-center ">
                                            ...
                                            <p className="text-body-text color-gray-500">Powerful filtering options help you sift through your data. Filter your data using criteria based on modules, for example - if you are analyzing deals module, you can drill down based on deal type, deal stage, sales cycle duration and so on.</p>
                                        </div>
                                    </li>
                                    <li className="icon-asset4 wow animate__animated animate__fadeIn" data-wow-delay=".9s">
                                        <div className="text-center ">
                                            ...
                                            <h3 className="text-heading-5 mb-10">Templates for easy analysis</h3>
                                            <p className="text-body-text color-gray-500">Choose which chart type works best for visualizing your data from a list of predefined templates. </p>
                                        </div>
                                    </li>
                                    <li className="wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                                        <div className="text-center ">
                                            ...
                                            <p className="text-body-text color-gray-500">Export your reports as Excel, CSV, or pdf files. Share your Dashboards with people who need access to them. Embed them into your website or share them on your Slack Channel. </p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
