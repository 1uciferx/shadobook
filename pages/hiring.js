              ...
              <div className="row">
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-12">
                    <div style={{ textAlign: "justify" }} className="box-optimized">
                  ...
                  <div className="col-lg-6 col-md-12 mt-80">
                      ...
                      <img className="img-responsive mt-0" src="/hiring/pic1.png" alt="Agon" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-2 ">
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 mt-0">
                      ...
                      <img  className="img-responsive mt-120 " src="/hiring/pic2.png" alt="Agon" />
                    </div>
                  </div>
                </div>
              </div>
