              ...
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p className="text-body-lead-large color-gray-500 mt-40 pr-40">
                    Real-time display of data such as exercise duration,
                    <br className="d-lg-block d-none" />
                    mileage, heart rate, etc
                  </p>
                  <div className="mt-40">
                ...
                <div className="col-lg-4 mt-50 d-none d-lg-block">
                  <div className="banner-imgs">
                    <div className="block-1 shape-2">
                      <img
                        src="/assets/imgs/page/homepage5/circle-1.svg"
                        alt="Agon"
                      />
                    </div>
          ...
          <div className="container mt-120 mb-60">
            <div className="row">
              <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                <div
                  className="product-item-1 wow animate__animated animate__fadeIn"
                  data-wow-delay=".1s"
                >
                  <Link href="#">
                    <a>
                      <div className="product-image">
                        <img src="/assets/imgs/page/homepage5/sp1.png" />
                      </div>
                      <div className="product-info">
                        <h3 className="title-product">
                          Bass ultra x-203. Head phone
                        </h3>
                        <span className="price-regular mr-15">$29.2</span>
                        <span className="price-regular price-line">$32.8</span>
                      </div>
                    </a>
                  </Link>
                </div>
              ...
              <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                ...
                >
                  <Link href="#">
                    <a>
                      <div className="product-image">
                        <img src="/assets/imgs/page/homepage5/sp2.png" />
                      </div>
                      <div className="product-info">
                        <h3 className="title-product">
                          Boxie by Dro C 3450. Active Noise
                        </h3>
                        <span className="price-regular mr-15">$35.6</span>
                        <span className="price-regular price-line">$36.4</span>
                      </div>
                    </a>
                  </Link>
                </div>
              ...
              <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                ...
                >
                  <Link href="#">
                    <a>
                      <div className="product-image">
                        <img src="/assets/imgs/page/homepage5/sp3.png" />
                      </div>
                      <div className="product-info">
                        <h3 className="title-product">
                          Sony DSC H300 - 20.1 Megapixel
                        </h3>
                        <span className="price-regular mr-15">$17.3</span>
                        <span className="price-regular price-line">$18.5</span>
                      </div>
                    </a>
                  </Link>
                </div>
              ...
              <div className="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                <div className="list-categories-number box-bdr-2 mb-30">
                  <div className="header-list-category">
                    <h3 className="text-body-lead-large font-bold">
                      Popular Categories
                    </h3>
                  </div>
                ...
                <ul className="list-steps">
                  <li className="icon-asset1">
                    <div className="text-center block-step bg-9 hover-up">
                      <div className="mb-30">
                        <img src="/assets/imgs/page/about/2/icon-start-plan.svg" />
                      </div>
                  ...
                  <li className="icon-asset2">
                    <div className="text-center block-step hover-up">
                      <div className="mb-30">
                        <img src="/assets/imgs/page/about/2/icon-connect.svg" />
                      </div>
                  ...
                  <li className="icon-asset3">
                    <div className="text-center block-step bg-5 hover-up">
                      <div className="mb-30">
                        <img src="/assets/imgs/page/about/2/icon-match.svg" />
                      </div>
                  ...
                  <li className="icon-asset4">
                    <div className="text-center block-step bg-5 hover-up">
                      <div className="mb-30">
                        <img src="/assets/imgs/page/about/2/icon-complete.svg" />
                      </div>
                  ...
                  <li>
                    <div className="text-center block-step bg-9 hover-up">
                      <div className="mb-30">
                        <img src="/assets/imgs/page/about/2/icon-review.svg" />
                      </div>
        ...
        <div className="section-box mt-70">
          <div className="container">
            <div className="box-green br-16">
              ...
              <div className="mt-30">
                <span className="cb-layout mr-30">
        ...
        <div className="section-box overflow-visible mt-120">
          <div className="container">
            <h2 className="text-heading-3 text-center color-gray-900 mb-60">
              Trusted by the world&rsquo;s leading companies
            </h2>
            <div className="row">
                  ...
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/agon.svg"
                        />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/monst.svg"
                        />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/figwire.svg"
                        />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/evara.svg"
                        />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/frox.svg"
                        />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/alithemes.svg"
                        />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/nestmask.svg"
                        />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/theflow.svg"
                        />
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="item-logo box-hover-shadow hover-up">
                        <img
                          alt="Agon"
                          src="assets/imgs/page/homepage5/stacker.svg"
                        />
                      </a>
                    </Link>
                  </li>
