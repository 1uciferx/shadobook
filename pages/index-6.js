              ...
              <div className="row">
                <div className="col-lg-7 mt-50 pb-120">
                  ...
                  <p className="text-body-lead-large color-gray-500 mt-30 pr-40">
                    ...
                    sheets. We bring the right people together
                  </p>
                  <div className="mt-40">
                    <Link href="#">
              ...
              <div className="col-lg-6">
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-6 col-12 pr-mb-70 mb-30">
                    ...
                    <span className="text-body-quote">Completed Cases</span>
                    <p className="text-body-text">
                      We always provide people a complete solution upon focused
                      of any business
                    </p>
                  </div>
                  <div className="col-lg-6 col-md-6 col-sm-6 col-12 pr-mb-70 mb-30">
                    ...
                    <span className="text-body-quote">Happy Clients</span>
                    <p className="text-body-text">
                      We always provide people a complete solution upon focused
                      of any business
                    </p>
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-6 col-12 pr-mb-70">
                    <h3 className="text-display-3">
                      <span className="count">18</span>k+
                    </h3>
                    <span className="text-body-quote">Skilled People</span>
                    <p className="text-body-text">
                      We always provide people a complete solution upon focused
                      of any business
                    </p>
              ...
              <div className="box-video-homepage6">
                <div className="box-image mt-30 mb-30">
                  ...
                  <img
                    ...
                    src="assets/imgs/page/homepage6/img.png"
                  />
                </div>
              </div>
              <div className="row">
