            ...
            <div className="container mt-50">
              <div className="row">
                <div className="col-lg-7">
                  <span className="tag-1 bg-6 color-green-900">Shadobooks</span>
                  <h1 className="text-display-4 font-bold mt-30">
                    Search Your{" "}
                    <span className="color-green-900">Next Holiday</span> from
                    Our Destinations
                  </h1>
                  ...
                  <div className="banner-imgs d-flex">
                    <div className="rounded-img shape-1">
                      <img
                        ...
                        alt="Agon"
                        src="https://res.cloudinary.com/ddap9cqvo/image/upload/v1677752317/zahir-namane-hwc7eIQiTCE-unsplash_xitway.jpg"
                      />
                    </div>
                    <div className="rounded-img mt-20 shape-1-2">
                      <img
                        className="img-responsive"
                        alt="Agon"
                        src="https://res.cloudinary.com/ddap9cqvo/image/upload/v1677751892/microsoft-365-7mBictB_urk-unsplash_mhyodc.jpg"
                      />
                    </div>
                    <div className="rounded-img shape-1">
                      <img
                        className="img-responsive"
                        alt="Agon"
                        src="assets/imgs/page/homepage8/banner3.png"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="popular-search mt-100">
                ...
                <ul className="list-search-popular">
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">New York</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">London</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Estonia</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Phuket</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Paris</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Nethelands</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Lotus Temple</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Eiffel Tower</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">The Colosseum</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Rome</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Statue of Liberty</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Machu Picchu</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Bali, Indonesia</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Orleans</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Kerry, Ireland</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Marrakesh</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Morocco</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Central</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Tokyo</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Dubai</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Bora Bora</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Dubrovnik</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Edinburgh</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Paro Valley</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Jaipur, India</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Waikato</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">Havana</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">NY, USA</a>
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      <a className="btn btn-border">West</a>
                    </Link>
                  </li>
                </ul>
              </div>
        ...
        <div className="section-box mt-100">
          <div className="container">
            ...
            <p className="text-body-lead-large color-gray-600 mt-20">
              We find the absolute best prices on hotels &amp; flights
              <br className="d-lg-block d-none" />
              then we pass these savings directly to you.
            </p>
          </div>
                  ...
                  <Link href="#">
                    <a>
                      <div className="product-image">
                        <img src="/assets/imgs/page/homepage8/img-3.png" />
                      </div>
                    </a>
                  </Link>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                ...
                >
                  <Link href="#">
                    <a>
                      <div className="product-image">
                        <img src="/assets/imgs/page/homepage8/img-4.png" />
                      </div>
                    </a>
                  </Link>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                ...
                >
                  <Link href="#">
                    <a>
                      <div className="product-image">
                        <img src="/assets/imgs/page/homepage8/img-5.png" />
                      </div>
                    </a>
                  </Link>
