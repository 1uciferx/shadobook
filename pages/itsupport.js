    ...
    <>
      <Layout>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                <div className="list-icons">
                  <div className="item-icon none-bd">
                    ...
                    <p className="text-body-text color-gray-600 mt-15">
                    There is little room for error while working in sales and marketing. We ShadoBook have a staff workflow that increases productivity during business hours by completing repetitive activities for you.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-6 col-sm-12 mb-30">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 col-sm-6 col-12 mt-50">
                    <h4 className="text-heading-6 icon-leaf">Bird-eye View all of the reports</h4>
                    <p className="text-body-excerpt color-gray-600 mt-15">
        ...
        <section className="section-box pt-140 pb-50">
            <div className="container">
              <div className="row">
              <h3 className="text-heading-1" style={{textAlign:"center",marginBottom:"50px",martinTop:"50px"}}>FAQ'S</h3>
