              ...
              <div className="row">
                <div className="col-lg-7">
                  ...
                  <p className="text-body-lead-large color-gray-900 mt-30 pr-40">
                    ...
                    variants, bills of materials and routing. <br></br>
                    <br></br>
                    This easy-to-access interface can help your business keep a
                    thorough record of your manufacturing process, their transit
                    and completing your work orders at proper timelines.
                  </p>
                </div>
