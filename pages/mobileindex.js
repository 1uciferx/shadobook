...
function Mobileindex() {
  ...
  return (
    <>
      ...
      <div className="banner-hero banner-homepage6 mt-120">
        <div className={styles.center}>
          <span>ShadoBooks - ERP Solutions</span>
        </div>
        <h1 className="text-display-3 mt-20 text-center">Best CRM Platform</h1>
        <p className={styles.mainpara}>
          Accounting Headache? SAY{" "}
          <span style={{ color: "#90331C" }}>GOODBYE</span>
          <br />
          Driving enterprise operations towards better ease of operations with
        ...
        <div className={styles.secondbox}>
          <div class={styles.container2}>
            <div class={styles.item3}>
              <h4 className={styles.boxheadingmain}>
            ...
            <div class={styles.item4}>
              <div className={styles.lastboxcontainer}>
                <div className={styles.lastboxicons}>
                  {" "}
                  <img
                    src="assets\imgs\page\homelogo\Accounting_voucher.png"
                    alt="shadobooks"
                  />
                </div>
                ...
                <div className={styles.lastboxicons}>
                  {" "}
                  <img
                    src="assets\imgs\page\homelogo\Powerfull_features.png"
                    alt="shadobooks"
                  />
                </div>
                <div>
                  <h5 className={styles.lastboxheading}>Realtime analytics</h5>
                  <p className={styles.lastboxpara}>
                ...
                <div className={styles.lastboxicons}>
                  {" "}
                  <img
                    src="assets\imgs\page\homelogo\Acquisition.png"
                    alt="shadobooks"
                  />
                </div>

                <div>
                  <h5 className={styles.lastboxheading}>Funnel optimization</h5>
                  <p className={styles.lastboxpara}>
                ...
                <div className={styles.lastboxicons}>
                  {" "}
                  <img
                    src="assets\imgs\page\homelogo\123.png"
                    alt="shadobooks"
                  />
                </div>
                <div>
            ...
            <div class={styles.item4}>
              <div className={styles.lastboxcontainer}>
                <div className={styles.lastboxicons}>
                  {" "}
                  <img
                    src="assets\imgs\page\homelogo\IT_Support.png"
                    alt="shadobooks"
                  />
                </div>
                ...
                <div className={styles.lastboxicons}>
                  {" "}
                  <img
                    src="assets\imgs\page\homelogo\OIL_Gas.png"
                    alt="shadobooks"
                  />
                </div>
                <div>
                  ...
                  <p className={styles.lastboxpara}>
                    Our CRM facilitates project-based sales in the oil and gas
                    sector.
                  </p>
                </div>
                ...
                <div className={styles.lastboxicons}>
                  {" "}
                  <img
                    src="assets\imgs\page\homelogo\manufacturing_1.png"
                    alt="shadobooks"
                  />
                </div>
                ...
                <div>
                  ...
                  <p className={styles.lastboxpara}>
                    Improve efficiency and google exposure with our intelligent
                    CRM.
                  </p>
                </div>
                ...
                <div className={styles.lastboxicons}>
                  {" "}
                  <img
                    src="assets\imgs\page\homelogo\Retail__Wholesalers.png"
                    alt="shadobooks"
                  />
                </div>
                <div>
                  ...
                  <p className={styles.lastboxpara}>
                    A unified customer service system across multiple channels.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="container">
        <div className="text-center mt-20">
          <h2 className={styles.boxheading23}>What We Do, What You Get</h2>
          <p className={styles.boxpara2}>
        ...
        <div className="row">
          <div className="col-lg-4 col-sm-12">
            <div className="card-grid-1 bg-2 bg-business hover-up">
              <div className={styles.center}>
                <img src="/assets/imgs/page/homepage1/aa2.png" alt="Agon" />
              </div>
              <h3 className="text-heading-4 text-center mt-20">Work smarter</h3>
              <p className={styles.boxpara2}>
                The dashboard unifies all your sales, marketing and customer
                support data while also giving you the leverage to customize the
                presentation in ways you deem fit for your operational flow in
                easy clicks.
              </p>
              {/* <div className="mt-30">
          ...
          <div className="col-lg-4 col-sm-12">
            <div className="card-grid-1 bg-2 bg-local hover-up">
              <div className={styles.center}>
                <img src="/assets/imgs/page/homepage1/dq22.png" alt="Agon" />
              </div>
              <h3 className="text-heading-4 text-center mt-20">
                Designed for teams
              </h3>
              <p className={styles.boxpara2}>
                You can organize all the KPIs in visual formats and spot trends
                through these interactive charts to drive your efforts in a
                better direction.
              </p>
            </div>
          </div>
          <div className="col-lg-4 col-sm-12">
            <div className="card-grid-1 bg-2 bg-social hover-up">
              <div className={styles.center}>
                <img src="/assets/imgs/page/homepage1/awe2222.png" alt="Agon" />
              </div>
              <h3 className="text-heading-4 text-center mt-20">
                Advanced analytics
              </h3>
              <p className={styles.boxpara2}>
                Hosting an abundance of data and breaking them down to formats
                that are easier to interpret while also giving you complete
                freedom.
              </p>
            </div>
          </div>
      ...
      <section className="section-box">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-8 col-sm-10 col-12 text-center mt-25">
        ...
        <div className="container mt-70">
          <div className="row">
            ...
            <div className="col-lg-4 col-sm-12">
              <div className="card-grid-1 bg-5 bg-local hover-up">
                <div className={styles.center}>
                  <img src="/assets/imgs/page/homepage1/local.svg" alt="Agon" />
                </div>
                <h3 className="text-heading-4 text-center mt-20">Activation</h3>
                <p className={styles.boxpara2}>
            ...
            <div className="col-lg-4 col-sm-12">
              <div className="card-grid-1 bg-5 bg-social hover-up">
                ...
                <h3 className="text-heading-4 text-center mt-20">Retention</h3>
                <p className={styles.boxpara2}>
      ...
      <div className="section-box  mt-10 bg-6">
        <div className="container">
          <div className="row">
            <div className="mb-30">
              ...
              <p className={styles.subcenterheading}>Our Happy Clients</p>
            </div>
            <div className="col-lg-7">
              <div className="row" data-masonry='{"percentPosition": true }'>
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className="card-grid-style-2 card-square hover-up mb-20">
                    <p className={styles.paratestimonials}>
