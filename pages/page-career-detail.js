                ...
                <div className="col-lg-12">
                  ...
                  <div className="breadcrumbs">
                    <ul className="text-body-text">
                      <li>
                        <Link href="/#">
                          <a className="color-gray-900">Home</a>
                        </Link>
                      </li>
                      <li>
                        <span className="color-gray-500">Jobs details</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="col-lg-8">
                  ...
                  <div className="media-block">
                    <Link href="/page-signup">
                      <a className="btn btn-green-900 color-white text-heading-6 icon-arrow-right-white mr-20">
                        Apply Now
                      </a>
                    </Link>
                    ...
                    <div className="float-start float-lg-end mt-30">
                      <Link href="/#">
                        <a className="btn btn-media mr-10">
                          <img
