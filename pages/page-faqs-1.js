              ...
              <div className="container">
                <div className="row">
                  <div className="col-lg-12 text-center">
                    <h1 className="text-display-3 color-white mb-30">
                    ...
                    <div className="form-round">
                      <form className="form-inline" action="#">
                        <input
                          ...
                          placeholder="Ark a questions..."
                        />
                        <input className="btn btn-round-icon" type="submit" />
                      </form>
                    </div>
                    <p className="text-body-lead color-white mt-40">
                      We are collect your searching keywords to improve our
                      services
                    </p>
                  </div>
                </div>
