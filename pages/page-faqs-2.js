            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-5">
                  <h1 className="text-heading-4 color-gray-900 mb-20">
                    Join the community with more than 12,368 topics already
                    created
                  </h1>
                  <p className="text-body-text color-gray-400">
                ...
                <div className="col-lg-7">
                  <div className="form-square">
                    <form className="form-inline" action="#">
                      <input
                        className="form-control input-with-button"
                        placeholder="Your question..."
                      />
                      <input
                        className="text-heading-6 btn btn-square-green"
                        type="submit"
                      />
                    </form>
                    <div className="block-tags">
                      <Link href="/page-pricing-1">
                        <a className="text-body-text color-gray-900">
                          Pricing plan <span className="icon-close" />
                        </a>
                      </Link>
                    </div>
                  </div>
          ...
          <section className="section-box mt-100">
            <div className="container text-center">
              ...
              <p className="text-body-lead-large color-gray-600 mt-30">
                ...
                contact us. We wil answer to you shortly! Meet our Support team
              </p>
            </div>
            <div className="container mt-70">
              <div className="row">
                <div className="col-lg-3 col-md-6 col-12">
                  <div
                    className="card-grid-style-3 hover-up wow animate__animated animate__fadeIn"
                    data-wow-delay=".1s"
                  >
                    ...
                    <p className="text-body-text text-desc color-gray-500 mt-20">
                      Even factoring differences in body weight between children
                ...
                <div className="col-lg-3 col-md-6 col-12">
                  <div
                    className="card-grid-style-3 bd-bg-6 hover-up wow animate__animated animate__fadeIn"
                    data-wow-delay=".3s"
                  >
                    <div className="grid-3-img">
                      <img
                    ...
                    <span className="text-body-small d-block">Nintendo</span>
                    <p className="text-body-text text-desc color-gray-500 mt-20">
                ...
                <div className="col-lg-3 col-md-6 col-12">
                  <div
                    className="card-grid-style-3 bd-bg-10 hover-up wow animate__animated animate__fadeIn"
                    data-wow-delay=".5s"
                  >
                    <div className="grid-3-img">
                      <img
                    ...
                    <span className="text-body-small d-block">Starbucks</span>
                    <p className="text-body-text text-desc color-gray-500 mt-20">
                      Their blood alcohol levels rose to 0.007 to 0.02 o/oo
                      (parts per thousand), or 0.7 to 2.0 mg/L.
                    </p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-6 col-12">
                  <div
                    className="card-grid-style-3 bd-bg-9 hover-up wow animate__animated animate__fadeIn"
                    data-wow-delay=".7s"
                  >
                    <div className="grid-3-img">
                      <img
