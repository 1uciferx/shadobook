                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-7">
                                    ...
                                    <p className="text-body-lead-large color-gray-500 mt-40 pr-40">The purchase section of the CRM enables complete operation assistance when it comes to the end-to-end requirements of your procurement cycle. From creating a purchase requisition document to the final payment, you can automate your process flow completely. <br></br><br></br>
